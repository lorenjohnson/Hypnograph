...
- [x] Complete WindowState generic dictionary-based implementation
- [x] Write focused tests for WindowState functionality
- [x] Replace WindowState.swift enum-based implementation with generic dictionary-based system
- [x] Add Codable conformance to WindowState
- [x] Ensure WindowState tests pass

#### Task Group 2: Automatic Window Registration
- [x] Complete automatic window registration system
- [x] Write focused tests for registration system
- [x] Design and implement automatic registration mechanism
- [x] Document registration system usage pattern
- [x] Ensure registration system tests pass

#### Task Group 3: Update All Window Usage Sites
- [x] Complete migration of all window usage to string keys
- [x] Update HypnographApp.swift keyboard shortcuts
- [x] Update ContentView.swift window visibility checks
- [x] Update Dream.swift module window checks
- [x] Update EffectsEditorView.swift
- [x] Search and update any remaining Window enum usage

#### Task Group 4: JSON Serialization and Persistence
- [x] Complete window state persistence implementation
- [x] Write focused tests for persistence
- [x] Determine and implement storage mechanism
- [x] Hook persistence into HypnographState
- [x] Test persistence end-to-end
...
- [x] Write additional strategic tests
- [x] Run all feature-specific tests
