...
- [x] Project: Unified Player Architecture: Shared A/B player infrastructure for Preview and Live with smooth transitions. Foundational work for transitions and volume leveling. Docs: `docs/Hypnograph/_archive/projects/20260116-unified-player-architecture/overview.md`, Plan: `docs/Hypnograph/_archive/projects/20260116-unified-player-architecture/implementation-planning.md`
- [x] Project: Hypnogram Transitions. Visual transitions between clip changes (Preview + Live). Depends on: Unified Player Architecture. Docs: `docs/Hypnograph/_archive/projects/20260116-hypnogram-transitions/overview.md`, Plan: `docs/Hypnograph/_archive/projects/20260116-hypnogram-transitions/implementation-planning.md`
...
- [x] Project: More Clear Naming. Naming cleanup for session/hypnogram/layer/media vocabulary. Docs: `docs/Hypnograph/_archive/projects/20260121-more-clear-naming/overview.md`, Plan: `docs/Hypnograph/_archive/projects/20260121-more-clear-naming/implementation-plan.md`
