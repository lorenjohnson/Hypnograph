...
/// Manages audio output routing for Studio's in-app and live players
@MainActor
final class AudioController: ObservableObject {
    ...
    private weak var settingsStore: StudioSettingsStore?
    ...
    init(settingsStore: StudioSettingsStore, livePlayer: LivePlayer) {
    ...
    // MARK: - StudioSettings Persistence

    /// Load audio device and volume settings from StudioSettings
    private func loadAudioSettings(from settings: StudioSettings) {
        // Load volumes
    ...
    /// Save audio device and volume settings to StudioSettings
