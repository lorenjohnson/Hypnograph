...
struct EffectsStudioPanelHostBridge: NSViewRepresentable {
    @ObservedObject var hostService: EffectsStudioPanelHostService
    ...
    final class Coordinator {
        var hostService: EffectsStudioPanelHostService

        init(hostService: EffectsStudioPanelHostService) {
