...
@MainActor
final class EffectsComposerTabKeyMonitorService: ObservableObject {
...
private enum EffectsComposerPanelKind: String {
    case code
    case parameters
    case manifest
    case liveControls
    ...
    var autosaveName: String {
        "Hypnograph.EffectsComposer.\(rawValue)"
    }
}

private final class EffectsComposerChildPanel: NSPanel {
...
final class EffectsComposerPanelHostService: ObservableObject {
    ...
    private var panels: [EffectsComposerPanelKind: ManagedPanel] = [:]
    ...
    private func ensurePanel(kind: EffectsComposerPanelKind, parentWindow: NSWindow) -> ManagedPanel {
    ...
    private func defaultFrame(kind: EffectsComposerPanelKind, parentWindow: NSWindow) -> NSRect {
