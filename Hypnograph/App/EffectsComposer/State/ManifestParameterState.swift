...
extension EffectsComposerViewModel {
    ...
    func canonicalChoiceValue(
        for draft: EffectsComposerParameterDraft,
        rawValue: AnyCodableValue
    ) -> AnyCodableValue {
        EffectsComposerParameterModeling.canonicalChoiceValue(for: draft, rawValue: rawValue)
    }
    ...
    static func sanitizedChoiceOptions(for param: EffectsComposerParameterDraft) -> [EffectsComposerChoiceOption] {
        EffectsComposerParameterModeling.sanitizedChoiceOptions(for: param)
    }

    static func resolvedChoiceDefaultKey(
        for param: EffectsComposerParameterDraft,
        options: [EffectsComposerChoiceOption]? = nil
    ) -> String {
        EffectsComposerParameterModeling.resolvedChoiceDefaultKey(for: param, options: options)
    }

    func runtimeParameterEntry(from param: EffectsComposerParameterDraft) -> RuntimeMetalParameterSchemaEntry? {
        EffectsComposerParameterModeling.runtimeParameterEntry(from: param)
    }
    ...
    static func defaultValue(for param: EffectsComposerParameterDraft) -> AnyCodableValue {
        EffectsComposerParameterModeling.defaultValue(for: param)
    }

    static func parameterSpec(for param: EffectsComposerParameterDraft) -> ParameterSpec {
        EffectsComposerParameterModeling.parameterSpec(for: param)
    }

    static func parameterDrafts(from manifest: RuntimeMetalEffectManifest) -> [EffectsComposerParameterDraft] {
        EffectsComposerParameterModeling.parameterDrafts(from: manifest)
    }

    static func paramType(from raw: String) -> EffectsComposerParamType? {
        EffectsComposerParameterModeling.paramType(from: raw)
    }

    static func scalarType(for dataType: MTLDataType) -> EffectsComposerScalarValueType? {
        EffectsComposerParameterModeling.scalarType(for: dataType)
    }

    static func scalarSize(for type: EffectsComposerScalarValueType) -> Int? {
        EffectsComposerParameterModeling.scalarSize(for: type)
    }

    static func isValidIdentifier(_ value: String) -> Bool {
        EffectsComposerParameterModeling.isValidIdentifier(value)
    }

    static func effectUUID(fromTypeName typeName: String) -> String? {
        EffectsComposerParameterModeling.effectUUID(fromTypeName: typeName)
    }

    static func isSystemParameterName(_ name: String) -> Bool {
        EffectsComposerParameterModeling.isSystemParameterName(name)
    }
    ...
    static var defaultParameters: [EffectsComposerParameterDraft] {
        EffectsComposerParameterModeling.defaultParameters
    }

    static var systemParameterBlueprints: [EffectsComposerParameterDraft] {
        EffectsComposerParameterModeling.systemParameterBlueprints
    }

    static var defaultCodeBody: String {
        EffectsComposerParameterModeling.defaultCodeBody
    }
}
