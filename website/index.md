...
<aside class="beta-inset beta-download download-cta">
  ...
  <p class="download-subtext">Open the downloaded file and drag <code>Hypnograph.app</code> into <code>Applications</code>. On first launch, it is expected that you will need to <a href="https://support.apple.com/en-afri/guide/mac-help/mh40617">override Security settings</a>.</p>
</aside>
